...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/bin/qguard', 'vendor/lib64/libqcodec2_utils.so', 'vendor/lib64/libqtiperfd.so'): blob_fixup()
    ...
    ('vendor/lib64/hw/libaudioeffecthal.qti.so', 'vendor/lib64/libdpps.so', 'vendor/lib64/libsnapdragoncolor-manager.so'): blob_fixup()
