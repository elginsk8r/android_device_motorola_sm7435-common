...
blob_fixups: blob_fixups_user_type = {
    ...
    ('system_ext/lib64/libwfddisplayconfig.so', 'vendor/bin/qguard', 'vendor/lib64/libaodoptfeature.so',
        'vendor/lib64/libapengine.so', 'vendor/lib64/libcamerapoweroptfeature.so',
        'vendor/lib64/libgamepoweroptfeature.so', 'vendor/lib64/liboffscreenpoweroptfeature.so',
        'vendor/lib64/libpsmoptfeature.so', 'vendor/lib64/libqcodec2_utils.so',
        'vendor/lib64/libqti-perfd.so', 'vendor/lib64/libqtiperfd.so', 'vendor/lib64/libvideooptfeature.so',
        'vendor/lib64/libwfddisplayconfig_vendor.so'): blob_fixup()
